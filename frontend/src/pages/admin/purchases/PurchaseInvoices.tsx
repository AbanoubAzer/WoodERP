...
import { ShoppingBag, Plus, Search, FileText, Download } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full pl-4 pr-10 py-3 bg-slate-50 border-none rounded-xl focus:ring-2 focus:ring-sky-500/20 text-slate-800"
            />
          </div>
          ...
          <div className="w-full md:w-64">
            <select
              ...
              className="w-full px-4 py-3 bg-slate-50 border-none rounded-xl text-slate-700 font-semibold focus:ring-2 focus:ring-sky-500/20"
            >
          ...
          <button
            onClick={() => {
              const rows: (string | number)[][] = [
                ['رقم الفاتورة', 'التاريخ', 'المورد', 'طريقة السداد', 'القيمة الإجمالية', 'المسدد', 'الباقي', 'الحالة']
              ];
              ...
              downloadCSV('فواتير_المشتريات', rows);
            }}
        ...
        <table className="w-full text-right">
          ...
          <tbody className="divide-y divide-slate-100">
            {paginatedInvoices.length === 0 ? (
              <tr><td colSpan={8} className="py-8 text-center text-slate-500">لا توجد فواتير مشتريات</td></tr>
            ) : (
