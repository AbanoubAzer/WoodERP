...
export function OverdueAlerts({ installments }: OverdueAlertsProps) {
  ...
  const GridContent = ({ data }: { data: any[] }) => (
      ...
      <div className="bg-red-50 border border-red-100 rounded-3xl p-6 shadow-sm mb-6 animate-in fade-in slide-in-from-top-4 duration-500">
        <div className="flex items-center justify-between mb-4">
          ...
          <button 
              ...
              className="text-xs font-bold text-red-600 hover:text-red-700 bg-red-100 hover:bg-red-200 px-3 py-1 rounded-lg transition-colors flex items-center gap-1"
            >
              عرض الكل
              <ArrowLeft size={14} />
            </button>
        ...
        <GridContent data={installments.slice(0, 3)} />
          ...
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6 border-b border-red-100 flex items-center justify-between bg-red-50">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-black text-slate-800">كل الأقساط المتأخرة</h2>
              </div>
              <button 
